class AppRoutes {
  ...
  static String playMovie(String id, String title, {String posterUrl = '', String backdropUrl = ''}) =>
  ...
  static String playTv(String id, String title, int season, int episode, {String posterUrl = '', String backdropUrl = ''}) =>
